...
เพิ่ม F1 score ของSVM ได้มากกว่าในreport ที่กล่าวมาข้างต้นจากที่ 76.4 % โดยปรับimblance data และ Feacture scaling (normalization) ใน pycarte F1 score = 93.34% 
